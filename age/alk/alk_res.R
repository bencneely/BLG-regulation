...
allaged_pre=bind_rows(JWSL_pre,LXLX_pre,MISL_pre,PTSB_pre,ZPCB_pre)
...
allaged_post=bind_rows(JWSL_post,LXLX_post,MISL_post,PTSB_post,ZPCB_post)

##############################################################
##############################################################
## Combine and export all aging data
allaged=bind_rows(allaged_pre,allaged_post)
export(allaged,"alk/allaged_res.csv")
